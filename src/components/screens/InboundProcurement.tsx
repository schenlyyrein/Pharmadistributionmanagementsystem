...
export function InboundProcurement() {
  ...
  const [providerVerification, setProviderVerification] =
    useState<ProviderVerificationResult | null>(null);
              ...
              <div>
                ...
                <Input
                  ...
                  onChange={(e) => {
                    ...
                    // Reset verification and debounce re-check
                ...
                {verifyingProvider && (
                  <div className="mt-2 flex items-center gap-1.5 text-xs text-[#6B7280]">
                    <div className="w-3.5 h-3.5 shrink-0 rounded-full border-2 border-[#6B7280] border-t-transparent animate-spin" />
                    <span>Verifying provider…</span>
                  </div>
                )}
                {!verifyingProvider && providerVerification && (
                  <div
                  ...
                  >
                    ...
                    <span>{providerVerification.reason}</span>
                  </div>
                )}
